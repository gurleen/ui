...
Prefer `Select` when there are many options or space is tight; prefer `RadioGroup` when there are few (2–5) options and users benefit from seeing them all at once.
